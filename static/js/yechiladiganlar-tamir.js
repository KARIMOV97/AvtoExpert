...
fetch("http://avtoexpert-production.up.railway.app/api/yechiladigan-detallar-tamirlash/")
  ...
  .then(data => {
    ...
    data.forEach(detail => {
      ...
      fetch("http://avtoexpert-production.up.railway.app/api/tamirlash-darajasi/")
        .then(res => res.json())
        .then(darajalar => {
